...
In this capstone, I have used e-commerce product reviews dataset to build a product recommendation system for the end users. The recommendations is improved using a sentiment analysis model.
